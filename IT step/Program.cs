...
Console.WriteLine("Task 2 and task 3 : \n\n");
//task 2 & task 3
Mydelegate AnonimousDel = delegate (string message)
{
    Console.WriteLine(message);
};
Mydelegate lambdaDel= message=>Console.WriteLine(message);

AnonimousDel("Invoked by Anonimous");
lambdaDel("Invoked by lambda");
